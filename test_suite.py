#!/usr/bin/env python3
"""
Callgraph Studio v2.2.1 — Full Automated Test Suite
...
# ══════════════════════════════════════════════════════════════
# 12. v2.2.1 FEATURE-SPECIFIC TESTS
# ══════════════════════════════════════════════════════════════
section("12. v2.2.1 feature checks")
...
# Version check
if "v2.2.1" in html:
    ok("Version: v2.2.1 in index.html")
else:
    fail("Version: v2.2.1 not found in index.html")
