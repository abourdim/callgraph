#!/usr/bin/env python3
"""
Callgraph Studio v1.8.0 — Full Automated Test Suite
...
# ══════════════════════════════════════════════════════════════
# 12. v1.8.0 FEATURE-SPECIFIC TESTS
# ══════════════════════════════════════════════════════════════
section("12. v1.8.0 feature checks")
...
# Version check
if "v1.8.0" in html:
    ok("Version: v1.8.0 in index.html")
else:
    fail("Version: v1.8.0 not found in index.html")
