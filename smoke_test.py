#!/usr/bin/env python3
"""
Callgraph Studio v2.2.1 — Smoke Test
...
# ══════════════════════════════════════════════════════════════
print(f"\n{B}══ Callgraph Studio v2.2.1 — Smoke Test ══{N}\n")
...
try:
    ...
    assert "Callgraph Studio" in body and "v2.2.1" in body
    ok("GET / → Callgraph Studio v2.2.1")
