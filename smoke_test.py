#!/usr/bin/env python3
"""
Callgraph Studio v2.3.0 — Smoke Test
...
# ══════════════════════════════════════════════════════════════
print(f"\n{B}══ Callgraph Studio v2.3.0 — Smoke Test ══{N}\n")
...
try:
    ...
    assert "Callgraph Studio" in body and "v2.3.0" in body
    ok("GET / → Callgraph Studio v2.3.0")
